...
void ComponentSignatureKeeper::Init() {
	...
	m_signatures.insert(std::make_pair(Component::Type::Drawable, Signature{std::array<bool, 3> { 1, 0, 0 }}));
	m_signatures.insert(std::make_pair(Component::Type::Hitbox2D, Signature{std::array<bool, 3> { 0, 1, 0 }}));
	m_signatures.insert(std::make_pair(Component::Type::Position, Signature{std::array<bool, 3> { 0, 0, 1 }}));
}
//END - AUTOGENERATED
