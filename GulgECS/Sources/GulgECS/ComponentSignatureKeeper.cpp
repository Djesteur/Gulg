...
void ComponentSignatureKeeper::Init() {
	...
	m_signatures.insert(std::make_pair(Component::Type::Drawable, Signature{std::array<bool, 2> { 1, 0 }}));
	m_signatures.insert(std::make_pair(Component::Type::Position, Signature{std::array<bool, 2> { 0, 1 }}));
}
//END - AUTOGENERATED
